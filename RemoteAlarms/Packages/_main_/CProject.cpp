...
#define VERIFY_WHOLE_PROGRAM_OPTIMIZATION VERIFY_PROJECT(Ralarm)
#include "CProject.h"
//(after-main-include-in-main-cpp-Ralarm)
...
void TheProjectCallback(out project_definition& out_oDefine)
{
    ...
    out_oDefine.m_szProjectLogo = "Ralarm";
...
void CProject::OnInitProject()
{
    ...
    /* // We cant preinit in OnInitProject() due to PatInfo dependency
