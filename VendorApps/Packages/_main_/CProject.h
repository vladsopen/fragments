...
private:
    CProject(); // the object can only be constructed in TheProjectCallback
             //  this ensures proper CustomApps Project initialization in all cases
...
// Global Objects
    ...
    //   In these cases the DLL is directly started with StartIcat.exe
...
protected:
    ...
    virtual void OnShutdownProject();
