...
#define VERIFY_WHOLE_PROGRAM_OPTIMIZATION VERIFY_PROJECT(CustomApps)
#include "CProject.h"
//(after-main-include-in-main-cpp-CustomApps)
...
void TheProjectCallback(out project_definition& out_oDefine)
{
    ...
    out_oDefine.m_szProjectLogo = "CustomApps";
    ...
    out_oDefine.m_fAppOption |= 0 |
        ...
        // for demo mode
        project_definition::F_AppOption_DisableAutoInstaller |
